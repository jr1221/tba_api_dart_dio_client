...
void main() {
  ...
  group(TeamApi, () {
    ...
    //
    //Future<BuiltList<DistrictRanking>> getDistrictRankings(String districtKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Team>> getDistrictTeams(String districtKey, { String ifNoneMatch }) async
    ...
    // Gets a list of `Team` objects that competed in events in the given district.
    //
    //Future<BuiltList<String>> getDistrictTeamsKeys(String districtKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<TeamSimple>> getDistrictTeamsSimple(String districtKey, { String ifNoneMatch }) async
    ...
    //
    //Future<Team> getTeam(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Award>> getTeamAwards(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Award>> getTeamAwardsByYear(String teamKey, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<DistrictList>> getTeamDistricts(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Match>> getTeamMatchesByYear(String teamKey, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<String>> getTeamMatchesByYearKeys(String teamKey, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<MatchSimple>> getTeamMatchesByYearSimple(String teamKey, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Media>> getTeamMediaByTag(String teamKey, String mediaTag, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Media>> getTeamMediaByTagYear(String teamKey, String mediaTag, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Media>> getTeamMediaByYear(String teamKey, int year, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<TeamRobot>> getTeamRobots(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<TeamSimple> getTeamSimple(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Media>> getTeamSocialMedia(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<int>> getTeamYearsParticipated(String teamKey, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Team>> getTeams(int pageNum, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<Team>> getTeamsByYear(int year, int pageNum, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<String>> getTeamsByYearKeys(int year, int pageNum, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<TeamSimple>> getTeamsByYearSimple(int year, int pageNum, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<String>> getTeamsKeys(int pageNum, { String ifNoneMatch }) async
    ...
    //
    //Future<BuiltList<TeamSimple>> getTeamsSimple(int pageNum, { String ifNoneMatch }) async
