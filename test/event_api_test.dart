...
void main() {
  ...
  group(EventApi, () {
    ...
    //
    //Future<BuiltList<EliminationAlliance>> getEventAlliances(String eventKey, { String ifModifiedSince }) async
    ...
    //
    //Future<BuiltList<Award>> getEventAwards(String eventKey, { String ifModifiedSince }) async
    ...
    //
    //Future<JsonObject> getEventPredictions(String eventKey, { String ifModifiedSince }) async
