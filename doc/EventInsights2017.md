# tba_api_dart_dio_client.model.EventInsights2017
...
**averageFuelPoints** | **double** | Average fuel points scored. | 
**averageFuelPointsAuto** | **double** | Average fuel points scored during auto. | 
**averageFuelPointsTeleop** | **double** | Average fuel points scored during teleop. | 
**averageHighGoals** | **double** | Average points scored in the high goal. | 
**averageHighGoalsAuto** | **double** | Average points scored in the high goal during auto. | 
**averageHighGoalsTeleop** | **double** | Average points scored in the high goal during teleop. | 
**averageLowGoals** | **double** | Average points scored in the low goal. | 
**averageLowGoalsAuto** | **double** | Average points scored in the low goal during auto. | 
**averageLowGoalsTeleop** | **double** | Average points scored in the low goal during teleop. | 
**averageMobilityPointsAuto** | **double** | Average mobility points scored during auto. | 
**averagePointsAuto** | **double** | Average points scored during auto. | 
**averagePointsTeleop** | **double** | Average points scored during teleop. | 
**averageRotorPoints** | **double** | Average rotor points scored. | 
**averageRotorPointsAuto** | **double** | Average rotor points scored during auto. | 
**averageRotorPointsTeleop** | **double** | Average rotor points scored during teleop. | 
