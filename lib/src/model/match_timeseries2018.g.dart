...
class MatchTimeseries2018Builder
  ...
  MatchTimeseries2018Builder get _$this {
    ...
    if ($v != null) {
      ...
      _blueAutoQuest = $v.blueAutoQuest;
      _blueBoostCount = $v.blueBoostCount;
      _blueBoostPlayed = $v.blueBoostPlayed;
      _blueCurrentPowerup = $v.blueCurrentPowerup;
      _blueFaceTheBoss = $v.blueFaceTheBoss;
      _blueForceCount = $v.blueForceCount;
      _blueForcePlayed = $v.blueForcePlayed;
      _blueLevitateCount = $v.blueLevitateCount;
      _blueLevitatePlayed = $v.blueLevitatePlayed;
      _bluePowerupTimeRemaining = $v.bluePowerupTimeRemaining;
      _blueScaleOwned = $v.blueScaleOwned;
      _blueScore = $v.blueScore;
      _blueSwitchOwned = $v.blueSwitchOwned;
      _redAutoQuest = $v.redAutoQuest;
      _redBoostCount = $v.redBoostCount;
      _redBoostPlayed = $v.redBoostPlayed;
      _redCurrentPowerup = $v.redCurrentPowerup;
      _redFaceTheBoss = $v.redFaceTheBoss;
      _redForceCount = $v.redForceCount;
      _redForcePlayed = $v.redForcePlayed;
      _redLevitateCount = $v.redLevitateCount;
      _redLevitatePlayed = $v.redLevitatePlayed;
      _redPowerupTimeRemaining = $v.redPowerupTimeRemaining;
      _redScaleOwned = $v.redScaleOwned;
      _redScore = $v.redScore;
      _redSwitchOwned = $v.redSwitchOwned;
      _$v = null;
    }
    return this;
  }
