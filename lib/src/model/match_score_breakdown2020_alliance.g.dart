...
class MatchScoreBreakdown2020AllianceBuilder
  ...
  MatchScoreBreakdown2020AllianceBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _initLineRobot1 = $v.initLineRobot1;
      _endgameRobot1 = $v.endgameRobot1;
      _initLineRobot2 = $v.initLineRobot2;
      _endgameRobot2 = $v.endgameRobot2;
      _initLineRobot3 = $v.initLineRobot3;
      _endgameRobot3 = $v.endgameRobot3;
      _autoCellsBottom = $v.autoCellsBottom;
      _autoCellsOuter = $v.autoCellsOuter;
      _autoCellsInner = $v.autoCellsInner;
      _teleopCellsBottom = $v.teleopCellsBottom;
      _teleopCellsOuter = $v.teleopCellsOuter;
      _teleopCellsInner = $v.teleopCellsInner;
      _stage1Activated = $v.stage1Activated;
      _stage2Activated = $v.stage2Activated;
      _stage3Activated = $v.stage3Activated;
      _stage3TargetColor = $v.stage3TargetColor;
      _endgameRungIsLevel = $v.endgameRungIsLevel;
      _autoInitLinePoints = $v.autoInitLinePoints;
      _autoCellPoints = $v.autoCellPoints;
      _autoPoints = $v.autoPoints;
      _teleopCellPoints = $v.teleopCellPoints;
      _controlPanelPoints = $v.controlPanelPoints;
