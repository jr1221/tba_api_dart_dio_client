...
class _$EventInsights2016 extends EventInsights2016 {
  ...
  _$EventInsights2016._(
      ...
      required this.aChevalDeFrise,
      required this.aPortcullis,
      required this.bRamparts,
      required this.bMoat,
      required this.cSallyPort,
      required this.cDrawbridge,
      required this.dRoughTerrain,
      required this.dRockWall,
      ...
      required this.averageAutoScore,
      required this.averageCrossingScore,
      required this.averageBoulderScore,
      required this.averageTowerScore,
...
class EventInsights2016Builder
  ...
  set bRamparts(ListBuilder<double>? bRamparts) =>
      _$this._bRamparts = bRamparts;
  ...
  set dRockWall(ListBuilder<double>? dRockWall) =>
      _$this._dRockWall = dRockWall;
  ...
  EventInsights2016Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      _lowBar = $v.lowBar.toBuilder();
      _aChevalDeFrise = $v.aChevalDeFrise.toBuilder();
      _aPortcullis = $v.aPortcullis.toBuilder();
      _bRamparts = $v.bRamparts.toBuilder();
      _bMoat = $v.bMoat.toBuilder();
      _cSallyPort = $v.cSallyPort.toBuilder();
      _cDrawbridge = $v.cDrawbridge.toBuilder();
      _dRoughTerrain = $v.dRoughTerrain.toBuilder();
      _dRockWall = $v.dRockWall.toBuilder();
      _averageHighGoals = $v.averageHighGoals;
      _averageLowGoals = $v.averageLowGoals;
      _breaches = $v.breaches.toBuilder();
      _scales = $v.scales.toBuilder();
      _challenges = $v.challenges.toBuilder();
      _captures = $v.captures.toBuilder();
      _averageWinScore = $v.averageWinScore;
      _averageWinMargin = $v.averageWinMargin;
      _averageScore = $v.averageScore;
      _averageAutoScore = $v.averageAutoScore;
      _averageCrossingScore = $v.averageCrossingScore;
      _averageBoulderScore = $v.averageBoulderScore;
      _averageTowerScore = $v.averageTowerScore;
    ...
    try {
      _$result = _$v ??
          new _$EventInsights2016._(
              lowBar: lowBar.build(),
              aChevalDeFrise: aChevalDeFrise.build(),
              aPortcullis: aPortcullis.build(),
              bRamparts: bRamparts.build(),
              bMoat: bMoat.build(),
              cSallyPort: cSallyPort.build(),
              cDrawbridge: cDrawbridge.build(),
