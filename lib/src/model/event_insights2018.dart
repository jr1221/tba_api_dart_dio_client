...
class _$EventInsights2018Serializer implements StructuredSerializer<EventInsights2018> {
    @override
    ...
    Iterable<Object?> serialize(Serializers serializers, EventInsights2018 object,
        ...
        result
            ...
            ..add(serializers.serialize(object.winningOwnSwitchOwnershipPercentageAuto,
                specifiedType: const FullType(double)));
        result
            ..add(r'winning_own_switch_ownership_percentage_teleop')
            ..add(serializers.serialize(object.winningOwnSwitchOwnershipPercentageTeleop,
                specifiedType: const FullType(double)));
        result
    ...
    @override
    EventInsights2018 deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        ...
        while (iterator.moveNext()) {
            ...
            switch (key) {
                ...
                case r'average_scale_ownership_points_auto':
                    result.averageScaleOwnershipPointsAuto = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'average_scale_ownership_points_teleop':
                    result.averageScaleOwnershipPointsTeleop = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                ...
                case r'average_switch_ownership_points_auto':
                    result.averageSwitchOwnershipPointsAuto = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'average_switch_ownership_points_teleop':
                    result.averageSwitchOwnershipPointsTeleop = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                ...
                case r'winning_opp_switch_denial_percentage_teleop':
                    result.winningOppSwitchDenialPercentageTeleop = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_own_switch_ownership_percentage':
                    result.winningOwnSwitchOwnershipPercentage = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_own_switch_ownership_percentage_auto':
                    result.winningOwnSwitchOwnershipPercentageAuto = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_own_switch_ownership_percentage_teleop':
                    result.winningOwnSwitchOwnershipPercentageTeleop = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_scale_ownership_percentage':
                    result.winningScaleOwnershipPercentage = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_scale_ownership_percentage_auto':
                    result.winningScaleOwnershipPercentageAuto = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
                case r'winning_scale_ownership_percentage_teleop':
                    result.winningScaleOwnershipPercentageTeleop = serializers.deserialize(value,
                        specifiedType: const FullType(double)) as double;
                    break;
            }
        }
