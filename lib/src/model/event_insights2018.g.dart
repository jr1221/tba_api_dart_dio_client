...
class _$EventInsights2018 extends EventInsights2018 {
  ...
  _$EventInsights2018._(
      ...
      required this.averageBoostPlayed,
      required this.averageEndgamePoints,
      required this.averageForcePlayed,
      required this.averageFoulScore,
      required this.averagePointsAuto,
      required this.averagePointsTeleop,
      required this.averageRunPointsAuto,
      required this.averageScaleOwnershipPoints,
      required this.averageScaleOwnershipPointsAuto,
      required this.averageScaleOwnershipPointsTeleop,
      required this.averageScore,
      required this.averageSwitchOwnershipPoints,
      required this.averageSwitchOwnershipPointsAuto,
      required this.averageSwitchOwnershipPointsTeleop,
      required this.averageVaultPoints,
      required this.averageWinMargin,
      required this.averageWinScore,
      required this.boostPlayedCounts,
      required this.climbCounts,
      required this.faceTheBossAchieved,
      required this.forcePlayedCounts,
      required this.highScore,
      required this.levitatePlayedCounts,
      required this.runCountsAuto,
      required this.scaleNeutralPercentage,
      required this.scaleNeutralPercentageAuto,
      required this.scaleNeutralPercentageTeleop,
      required this.switchOwnedCountsAuto,
      required this.unicornMatches,
      required this.winningOppSwitchDenialPercentageTeleop,
      required this.winningOwnSwitchOwnershipPercentage,
      required this.winningOwnSwitchOwnershipPercentageAuto,
      required this.winningOwnSwitchOwnershipPercentageTeleop,
      required this.winningScaleOwnershipPercentage,
...
class EventInsights2018Builder
  ...
  EventInsights2018Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      _autoQuestAchieved = $v.autoQuestAchieved.toBuilder();
      _averageBoostPlayed = $v.averageBoostPlayed;
      _averageEndgamePoints = $v.averageEndgamePoints;
      _averageForcePlayed = $v.averageForcePlayed;
      _averageFoulScore = $v.averageFoulScore;
      _averagePointsAuto = $v.averagePointsAuto;
      _averagePointsTeleop = $v.averagePointsTeleop;
      _averageRunPointsAuto = $v.averageRunPointsAuto;
      _averageScaleOwnershipPoints = $v.averageScaleOwnershipPoints;
      _averageScaleOwnershipPointsAuto = $v.averageScaleOwnershipPointsAuto;
      _averageScaleOwnershipPointsTeleop = $v.averageScaleOwnershipPointsTeleop;
      ...
      _boostPlayedCounts = $v.boostPlayedCounts.toBuilder();
      _climbCounts = $v.climbCounts.toBuilder();
      _faceTheBossAchieved = $v.faceTheBossAchieved.toBuilder();
      _forcePlayedCounts = $v.forcePlayedCounts.toBuilder();
      _highScore = $v.highScore.toBuilder();
      _levitatePlayedCounts = $v.levitatePlayedCounts.toBuilder();
      _runCountsAuto = $v.runCountsAuto.toBuilder();
      _scaleNeutralPercentage = $v.scaleNeutralPercentage;
      _scaleNeutralPercentageAuto = $v.scaleNeutralPercentageAuto;
    ...
    try {
      _$result = _$v ??
          new _$EventInsights2018._(
              ...
              forcePlayedCounts: forcePlayedCounts.build(),
