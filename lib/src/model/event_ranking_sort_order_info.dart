...
abstract class EventRankingSortOrderInfo implements Built<EventRankingSortOrderInfo, EventRankingSortOrderInfoBuilder> {
    ...
    factory EventRankingSortOrderInfo([void updates(EventRankingSortOrderInfoBuilder b)]) = _$EventRankingSortOrderInfo;

    @BuiltValueSerializer(custom: true)
    static Serializer<EventRankingSortOrderInfo> get serializer => _$EventRankingSortOrderInfoSerializer();
}

class _$EventRankingSortOrderInfoSerializer implements StructuredSerializer<EventRankingSortOrderInfo> {
    @override
    final Iterable<Type> types = const [EventRankingSortOrderInfo, _$EventRankingSortOrderInfo];

    @override
    final String wireName = r'EventRankingSortOrderInfo';

    @override
    Iterable<Object?> serialize(Serializers serializers, EventRankingSortOrderInfo object,
    ...
    @override
    EventRankingSortOrderInfo deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
