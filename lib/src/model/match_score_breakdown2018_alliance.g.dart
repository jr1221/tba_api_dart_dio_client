...
class _$MatchScoreBreakdown2018Alliance
  ...
  factory _$MatchScoreBreakdown2018Alliance(
      ...
      (new MatchScoreBreakdown2018AllianceBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MatchScoreBreakdown2018Alliance')
...
class MatchScoreBreakdown2018AllianceBuilder
  ...
  MatchScoreBreakdown2018AllianceBuilder() {
    MatchScoreBreakdown2018Alliance._defaults(this);
  }
  ...
  MatchScoreBreakdown2018AllianceBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _autoOwnershipPoints = $v.autoOwnershipPoints;
      _autoPoints = $v.autoPoints;
      _autoQuestRankingPoint = $v.autoQuestRankingPoint;
      _autoRobot1 = $v.autoRobot1;
      _autoRobot2 = $v.autoRobot2;
      _autoRobot3 = $v.autoRobot3;
      _autoRunPoints = $v.autoRunPoints;
      _autoScaleOwnershipSec = $v.autoScaleOwnershipSec;
      _autoSwitchAtZero = $v.autoSwitchAtZero;
      _autoSwitchOwnershipSec = $v.autoSwitchOwnershipSec;
      _endgamePoints = $v.endgamePoints;
      _endgameRobot1 = $v.endgameRobot1;
      _endgameRobot2 = $v.endgameRobot2;
      _endgameRobot3 = $v.endgameRobot3;
      _faceTheBossRankingPoint = $v.faceTheBossRankingPoint;
      _foulCount = $v.foulCount;
      _foulPoints = $v.foulPoints;
      _rp = $v.rp;
      _techFoulCount = $v.techFoulCount;
      _teleopOwnershipPoints = $v.teleopOwnershipPoints;
      _teleopPoints = $v.teleopPoints;
      _teleopScaleBoostSec = $v.teleopScaleBoostSec;
      _teleopScaleForceSec = $v.teleopScaleForceSec;
      _teleopScaleOwnershipSec = $v.teleopScaleOwnershipSec;
      _teleopSwitchBoostSec = $v.teleopSwitchBoostSec;
      _teleopSwitchForceSec = $v.teleopSwitchForceSec;
      _teleopSwitchOwnershipSec = $v.teleopSwitchOwnershipSec;
      _totalPoints = $v.totalPoints;
      _vaultBoostPlayed = $v.vaultBoostPlayed;
      _vaultBoostTotal = $v.vaultBoostTotal;
      _vaultForcePlayed = $v.vaultForcePlayed;
      _vaultForceTotal = $v.vaultForceTotal;
      _vaultLevitatePlayed = $v.vaultLevitatePlayed;
      _vaultLevitateTotal = $v.vaultLevitateTotal;
      _vaultPoints = $v.vaultPoints;
      _tbaGameData = $v.tbaGameData;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  MatchScoreBreakdown2018Alliance build() => _build();

  _$MatchScoreBreakdown2018Alliance _build() {
    final _$result = _$v ??
