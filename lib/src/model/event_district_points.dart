            ...
            switch (key) {
                case r'points':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(EventDistrictPointsPointsValue)])) as BuiltMap<String, EventDistrictPointsPointsValue>;
                    result.points.replace(valueDes);
                    break;
                case r'tiebreakers':
                    final valueDes = serializers.deserialize(value,
                        specifiedType: const FullType(BuiltMap, [FullType(String), FullType(EventDistrictPointsTiebreakersValue)])) as BuiltMap<String, EventDistrictPointsTiebreakersValue>;
