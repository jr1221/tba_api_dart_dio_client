    ...
    result
      ...
      ..add(serializers.serialize(object.points,
          specifiedType: const FullType(BuiltMap,
              [FullType(String), FullType(EventDistrictPointsPoints)])));
    if (object.tiebreakers != null) {
      result
        ..add(r'tiebreakers')
        ..add(serializers.serialize(object.tiebreakers,
            specifiedType: const FullType(BuiltMap,
                [FullType(String), FullType(EventDistrictPointsTiebreakers)])));
    }
    return result;
  }
      ...
      switch (key) {
        case r'points':
          result.points.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltMap, [
                FullType(String),
                FullType(EventDistrictPointsPoints)
              ])) as BuiltMap<String, EventDistrictPointsPoints>);
          break;
        case r'tiebreakers':
          result.tiebreakers.replace(serializers.deserialize(value,
              specifiedType: const FullType(BuiltMap, [
                FullType(String),
                FullType(EventDistrictPointsTiebreakers)
              ])) as BuiltMap<String, EventDistrictPointsTiebreakers>);
          break;
      }
    }
    return result.build();
