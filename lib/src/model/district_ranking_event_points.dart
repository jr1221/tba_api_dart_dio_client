...
abstract class DistrictRankingEventPoints implements Built<DistrictRankingEventPoints, DistrictRankingEventPointsBuilder> {
    ...
    factory DistrictRankingEventPoints([void updates(DistrictRankingEventPointsBuilder b)]) = _$DistrictRankingEventPoints;

    @BuiltValueSerializer(custom: true)
    static Serializer<DistrictRankingEventPoints> get serializer => _$DistrictRankingEventPointsSerializer();
}

class _$DistrictRankingEventPointsSerializer implements StructuredSerializer<DistrictRankingEventPoints> {
    @override
    final Iterable<Type> types = const [DistrictRankingEventPoints, _$DistrictRankingEventPoints];

    @override
    final String wireName = r'DistrictRankingEventPoints';

    @override
    Iterable<Object?> serialize(Serializers serializers, DistrictRankingEventPoints object,
    ...
    @override
    DistrictRankingEventPoints deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
