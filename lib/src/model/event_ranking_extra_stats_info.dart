...
abstract class EventRankingExtraStatsInfo implements Built<EventRankingExtraStatsInfo, EventRankingExtraStatsInfoBuilder> {
    ...
    factory EventRankingExtraStatsInfo([void updates(EventRankingExtraStatsInfoBuilder b)]) = _$EventRankingExtraStatsInfo;

    @BuiltValueSerializer(custom: true)
    static Serializer<EventRankingExtraStatsInfo> get serializer => _$EventRankingExtraStatsInfoSerializer();
}

class _$EventRankingExtraStatsInfoSerializer implements StructuredSerializer<EventRankingExtraStatsInfo> {
    @override
    final Iterable<Type> types = const [EventRankingExtraStatsInfo, _$EventRankingExtraStatsInfo];

    @override
    final String wireName = r'EventRankingExtraStatsInfo';

    @override
    Iterable<Object?> serialize(Serializers serializers, EventRankingExtraStatsInfo object,
    ...
    @override
    EventRankingExtraStatsInfo deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
