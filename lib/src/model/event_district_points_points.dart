...
abstract class EventDistrictPointsPoints implements Built<EventDistrictPointsPoints, EventDistrictPointsPointsBuilder> {
    ...
    factory EventDistrictPointsPoints([void updates(EventDistrictPointsPointsBuilder b)]) = _$EventDistrictPointsPoints;

    @BuiltValueSerializer(custom: true)
    static Serializer<EventDistrictPointsPoints> get serializer => _$EventDistrictPointsPointsSerializer();
}

class _$EventDistrictPointsPointsSerializer implements StructuredSerializer<EventDistrictPointsPoints> {
    @override
    final Iterable<Type> types = const [EventDistrictPointsPoints, _$EventDistrictPointsPoints];

    @override
    final String wireName = r'EventDistrictPointsPoints';

    @override
    Iterable<Object?> serialize(Serializers serializers, EventDistrictPointsPoints object,
    ...
    @override
    EventDistrictPointsPoints deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
