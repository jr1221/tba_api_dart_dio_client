...
class _$EventInsights2017 extends EventInsights2017 {
  ...
  _$EventInsights2017._(
      ...
      required this.averageFuelPoints,
      required this.averageFuelPointsAuto,
      required this.averageFuelPointsTeleop,
      required this.averageHighGoals,
      required this.averageHighGoalsAuto,
      required this.averageHighGoalsTeleop,
      required this.averageLowGoals,
      required this.averageLowGoalsAuto,
      required this.averageLowGoalsTeleop,
      required this.averageMobilityPointsAuto,
      required this.averagePointsAuto,
      required this.averagePointsTeleop,
      required this.averageRotorPoints,
      required this.averageRotorPointsAuto,
      required this.averageRotorPointsTeleop,
      required this.averageScore,
      required this.averageTakeoffPointsTeleop,
      required this.averageWinMargin,
      required this.averageWinScore,
      required this.highKpa,
      required this.highScore,
      required this.kpaAchieved,
      required this.mobilityCounts,
      required this.rotor1Engaged,
      required this.rotor1EngagedAuto,
      required this.rotor2Engaged,
      required this.rotor2EngagedAuto,
      required this.rotor3Engaged,
      required this.rotor4Engaged,
...
class EventInsights2017Builder
  ...
  EventInsights2017Builder get _$this {
    final $v = _$v;
    if ($v != null) {
      _averageFoulScore = $v.averageFoulScore;
      _averageFuelPoints = $v.averageFuelPoints;
      _averageFuelPointsAuto = $v.averageFuelPointsAuto;
      _averageFuelPointsTeleop = $v.averageFuelPointsTeleop;
      _averageHighGoals = $v.averageHighGoals;
      _averageHighGoalsAuto = $v.averageHighGoalsAuto;
      _averageHighGoalsTeleop = $v.averageHighGoalsTeleop;
      _averageLowGoals = $v.averageLowGoals;
      _averageLowGoalsAuto = $v.averageLowGoalsAuto;
      _averageLowGoalsTeleop = $v.averageLowGoalsTeleop;
      _averageMobilityPointsAuto = $v.averageMobilityPointsAuto;
      _averagePointsAuto = $v.averagePointsAuto;
      _averagePointsTeleop = $v.averagePointsTeleop;
      _averageRotorPoints = $v.averageRotorPoints;
      _averageRotorPointsAuto = $v.averageRotorPointsAuto;
      _averageRotorPointsTeleop = $v.averageRotorPointsTeleop;
      _averageScore = $v.averageScore;
      _averageTakeoffPointsTeleop = $v.averageTakeoffPointsTeleop;
      _averageWinMargin = $v.averageWinMargin;
      _averageWinScore = $v.averageWinScore;
      _highKpa = $v.highKpa.toBuilder();
      _highScore = $v.highScore.toBuilder();
      _kpaAchieved = $v.kpaAchieved.toBuilder();
      _mobilityCounts = $v.mobilityCounts.toBuilder();
      _rotor1Engaged = $v.rotor1Engaged.toBuilder();
      _rotor1EngagedAuto = $v.rotor1EngagedAuto.toBuilder();
      _rotor2Engaged = $v.rotor2Engaged.toBuilder();
      _rotor2EngagedAuto = $v.rotor2EngagedAuto.toBuilder();
      _rotor3Engaged = $v.rotor3Engaged.toBuilder();
      _rotor4Engaged = $v.rotor4Engaged.toBuilder();
      _takeoffCounts = $v.takeoffCounts.toBuilder();
    ...
    try {
      _$result = _$v ??
          new _$EventInsights2017._(
              ...
              mobilityCounts: mobilityCounts.build(),
              rotor1Engaged: rotor1Engaged.build(),
              rotor1EngagedAuto: rotor1EngagedAuto.build(),
              rotor2Engaged: rotor2Engaged.build(),
              rotor2EngagedAuto: rotor2EngagedAuto.build(),
              rotor3Engaged: rotor3Engaged.build(),
              rotor4Engaged: rotor4Engaged.build(),
              takeoffCounts: takeoffCounts.build(),
