...
MatchScoreBreakdown2016AllianceRobot1AutoEnum
  ...
  switch (name) {
    ...
    case 'reached':
      return _$matchScoreBreakdown2016AllianceRobot1AutoEnum_reached;
    case 'none':
      return _$matchScoreBreakdown2016AllianceRobot1AutoEnum_none;
    default:
...
MatchScoreBreakdown2016AllianceRobot2AutoEnum
  ...
  switch (name) {
    ...
    case 'reached':
      return _$matchScoreBreakdown2016AllianceRobot2AutoEnum_reached;
    case 'none':
      return _$matchScoreBreakdown2016AllianceRobot2AutoEnum_none;
    default:
      throw new ArgumentError(name);
  }
}
...
MatchScoreBreakdown2016AllianceRobot3AutoEnum
  ...
  switch (name) {
    ...
    case 'reached':
      return _$matchScoreBreakdown2016AllianceRobot3AutoEnum_reached;
    case 'none':
      return _$matchScoreBreakdown2016AllianceRobot3AutoEnum_none;
    default:
      throw new ArgumentError(name);
  }
}
...
class _$MatchScoreBreakdown2016Alliance
  ...
  @override
  final MatchScoreBreakdown2016AllianceRobot1AutoEnum? robot1Auto;
  @override
  final MatchScoreBreakdown2016AllianceRobot2AutoEnum? robot2Auto;
  @override
  final MatchScoreBreakdown2016AllianceRobot3AutoEnum? robot3Auto;
  @override
  ...
  factory _$MatchScoreBreakdown2016Alliance(
      ...
      (new MatchScoreBreakdown2016AllianceBuilder()..update(updates))._build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MatchScoreBreakdown2016Alliance')
...
class MatchScoreBreakdown2016AllianceBuilder
  ...
  MatchScoreBreakdown2016AllianceBuilder() {
    MatchScoreBreakdown2016Alliance._defaults(this);
  }
  ...
  MatchScoreBreakdown2016AllianceBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _breachPoints = $v.breachPoints;
      _foulPoints = $v.foulPoints;
      _capturePoints = $v.capturePoints;
      _adjustPoints = $v.adjustPoints;
      _totalPoints = $v.totalPoints;
      _robot1Auto = $v.robot1Auto;
      _robot2Auto = $v.robot2Auto;
      _robot3Auto = $v.robot3Auto;
      _autoReachPoints = $v.autoReachPoints;
      _autoCrossingPoints = $v.autoCrossingPoints;
      _autoBouldersLow = $v.autoBouldersLow;
      _autoBouldersHigh = $v.autoBouldersHigh;
      _autoBoulderPoints = $v.autoBoulderPoints;
      _teleopCrossingPoints = $v.teleopCrossingPoints;
      _teleopBouldersLow = $v.teleopBouldersLow;
      _teleopBouldersHigh = $v.teleopBouldersHigh;
      _teleopBoulderPoints = $v.teleopBoulderPoints;
      _teleopDefensesBreached = $v.teleopDefensesBreached;
      _teleopChallengePoints = $v.teleopChallengePoints;
      _teleopScalePoints = $v.teleopScalePoints;
      _teleopTowerCaptured = $v.teleopTowerCaptured;
      _towerFaceA = $v.towerFaceA;
      _towerFaceB = $v.towerFaceB;
      _towerFaceC = $v.towerFaceC;
      _towerEndStrength = $v.towerEndStrength;
      _techFoulCount = $v.techFoulCount;
      _foulCount = $v.foulCount;
      _position2 = $v.position2;
      _position3 = $v.position3;
      _position4 = $v.position4;
      _position5 = $v.position5;
      _position1crossings = $v.position1crossings;
      _position2crossings = $v.position2crossings;
      _position3crossings = $v.position3crossings;
      _position4crossings = $v.position4crossings;
      _position5crossings = $v.position5crossings;
      _$v = null;
    }
    return this;
  }
  ...
  @override
  MatchScoreBreakdown2016Alliance build() => _build();

  _$MatchScoreBreakdown2016Alliance _build() {
    final _$result = _$v ??
