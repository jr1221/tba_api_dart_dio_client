...
class _$DistrictRankingSerializer implements StructuredSerializer<DistrictRanking> {
    @override
        ...
        if (object.eventPoints != null) {
            result
                ...
                ..add(serializers.serialize(object.eventPoints,
                    specifiedType: const FullType(BuiltList, [FullType(DistrictRankingEventPoints)])));
        }
        return result;
    }

    @override
    DistrictRanking deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
            ...
            switch (key) {
                ...
                case r'event_points':
                    result.eventPoints.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(DistrictRankingEventPoints)])) as BuiltList<DistrictRankingEventPoints>);
                    break;
            }
        }
        return result.build();
