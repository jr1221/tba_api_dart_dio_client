...
abstract class EventDistrictPointsTiebreakers implements Built<EventDistrictPointsTiebreakers, EventDistrictPointsTiebreakersBuilder> {
    ...
    factory EventDistrictPointsTiebreakers([void updates(EventDistrictPointsTiebreakersBuilder b)]) = _$EventDistrictPointsTiebreakers;

    @BuiltValueSerializer(custom: true)
    static Serializer<EventDistrictPointsTiebreakers> get serializer => _$EventDistrictPointsTiebreakersSerializer();
}

class _$EventDistrictPointsTiebreakersSerializer implements StructuredSerializer<EventDistrictPointsTiebreakers> {
    @override
    final Iterable<Type> types = const [EventDistrictPointsTiebreakers, _$EventDistrictPointsTiebreakers];

    @override
    final String wireName = r'EventDistrictPointsTiebreakers';

    @override
    Iterable<Object?> serialize(Serializers serializers, EventDistrictPointsTiebreakers object,
    ...
    @override
    EventDistrictPointsTiebreakers deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
